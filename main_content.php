<div class="container mt-4">
    ...
    <ul class="nav nav-tabs" id="productTabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="all-products-tab" data-toggle="tab" href="#all-products" role="tab"
    ...
    <div class="tab-content" id="productTabsContent">
        <div class="tab-pane fade show active" id="all-products" role="tabpanel" aria-labelledby="all-products-tab">
            <div class="product-carousel mt-4">
                ...
                <div class="card mb-4">
                    <img src="petugas/image/<?php echo htmlspecialchars($product['gambar']); ?>"
                        class="card-img-top img-fluid" alt="<?php echo htmlspecialchars($product['nama']); ?>">
                    <div class="card-body">
                        ...
                        <a href="add_to_cart.php?id_produk=<?php echo urlencode($product['id_produk']); ?>"
                            class="btn btn-light">Add to Cart</a>
                    </div>
                </div>
                <?php endforeach; ?>
                <?php else: ?>
