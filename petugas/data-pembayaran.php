            ...
            <div class="col-12">
                ...
                <div class="card">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="../uploads/<?php echo $row['file']; ?>"
                                            download="">
                    ...
                    ?>
                                    ...
                                    <td>
                                        <?php if($row['status'] == 0): ?>
                                        <a href="index.php?page=validate-transaksi&action=setuju&id=<?php echo $row['id_bukti']; ?>&id_transaksi=<?php echo $row['id_transaksi']; ?>"
                                            class="btn btn-success"
                                            onclick="return confirm('Apakah Anda yakin ingin menyetujui transaksi ini?')">
                                            <i class="fas fa-check"></i>
                                            Setuju
                                        </a>
                                        <a href="index.php?page=validate-transaksi&action=tolak&id=<?php echo $row['id_bukti']; ?>&id_transaksi=<?php echo $row['id_transaksi']; ?>"
