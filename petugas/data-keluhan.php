              ...
              <tbody>
                <?php while ($row = $result->fetch_assoc()) : ?>
                  <tr>
                    ...
                    <td>
                      <?php if ($row['status'] == 0) : ?>
                        <a href="index.php?page=data-keluhan&action=setuju&id=<?php echo $row['id_keluhan']; ?>" class="btn btn-success" onclick="return confirm('Apakah Anda yakin ingin menyetujui keluhan ini?')">
                          <i class="fas fa-check"></i>
                          Setuju
                        </a>
                        <a href="index.php?page=data-keluhan&action=tolak&id=<?php echo $row['id_keluhan']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin membatalkan keluhan ini?')">
